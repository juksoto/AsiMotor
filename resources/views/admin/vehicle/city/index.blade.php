...
@section('content')
    ...
    <article class="row">
        <div class="col-md-12">
            <h1 class="title_main text-capitalize">
                {{ trans('admin.menu.settings|city') }}
                <span>
    ...
    {!! Form::model(Request::all(),['route' => 'admin.city.index', 'method' => 'GET' , 'class' => 'row margin-xs-bottom no-margin-md-bottom' ])!!}
        <!-- Section Filter -->
        ...
        <article class="col-md-4 col-sm-6 text-sm-center">
            <ul class="list-inline text-xs-center text-md-left">
                ...
                <li class="text-left">
                    <a class="btn btn-danger" href="{{ route('admin.city.index') }}">
