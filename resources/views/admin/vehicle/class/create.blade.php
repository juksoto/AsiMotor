...
@section('content')
    ...
    <section class="row">
        <article class="col-md-12">
            <h1>
                {!! trans('admin.vehicle.create_vehicle_class') !!}
            </h1>
            <p>
               {!! trans('admin.vehicle.create_content_vehicle_class') !!}
            </p>
        </article>
    </section>

    {!! Form::open(['route' => 'admin.vehicle.class.store', 'method' => 'POST', 'class' => 'form-horizontal' , 'id' => 'form'])!!}
