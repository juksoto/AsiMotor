...
@section('content')
    ...
    <section class="row">
        <article class="col-xs-12">
            <h1 class="title_main">
                {!! $data -> collection -> vehicle_class !!}
                <span>
                    {!! trans('admin.vehicle.edit_vehicle_class') !!}
                </span>
            </h1>
            <p>
                {!! trans('admin.vehicle.edit_content_vehicle_class') !!}
            </p>
        </article>
    </section>

    {!! Form::model($data -> collection,['route' => ['admin.vehicle.class.update', $data -> collection], 'method' => 'PUT', 'class' => 'form-horizontal', 'id' => 'form'])!!}
    ...
    <!-- Section Fields -->
        @include('admin.vehicle.class.partials.fields')
    <!-- End Section Fields -->
    ...
    <section class="form-group">
        ...
        <article class="col-md-offset-1 col-sm-6 text-md-left text-xs-center col-xs-12 col-md-4">
            ...
            <a class="btn btn-danger" href="{{ route('admin.vehicle.class.index') }}">{{ trans('admin.submit.back') }}</a>
        </article>
        ...
        <article class="col-md-offset-4 col-md-2 col-sm-6 col-xs-12 col-sm-offset-0 text-sm-right text-xs-center margin-xs-top no-margin-sm-top">
            ...
            {!! Form::open(['route' => ['admin.vehicle.class.destroy', $data -> collection], 'method' => 'DELETE', 'class' => '' ])!!}
