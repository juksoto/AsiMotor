...
@section('content')
    ...
    <section class="row">
        <article class="col-md-12">
            <h1>
                {!! trans('admin.vehicle.create_vehicle_line') !!}
            </h1>
            <p>
               {!! trans('admin.vehicle.create_content_vehicle_line') !!}
            </p>
        </article>
    </section>

    {!! Form::open(['route' => 'admin.vehicle.line.store', 'method' => 'POST', 'class' => 'form-horizontal' , 'id' => 'form'])!!}
...
@section('scripts')
    ...
    @include('admin.vehicle.line.partials.scripts')
